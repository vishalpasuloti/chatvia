...
export function Vishal() {
    ...
    async function saveData(data) {
        ...
        formData.append("userVishalid", user.id);
        ...
        await axios.post("http://localhost:4000/addvishal", formData);
        reset();
        setMessage(""); 
        getVischat(); 
    }
    ...
    async function getVischat() {
        const url = "http://localhost:4000/getvishalchat/"+id;
...
<div className="row p-1 avi">
  ...
  <img src={require("../../assets/images/prof.jpg")} height="35" alt="" className="profile-user rounded-circle" /><span className="ms-2 mt-2" style={{ fontSize: "15px",fontWeight:'bold' }}>Mark Messer</span>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div className="" style={{textAlign:'center'}}>
        ...
        <div className=""><h3>Mark Messer</h3></div>
...
<div className=" mt-3" style={{ width: "871px",height: "430px"}}>
                        ...
                        {vischat.map((item, index) => (
                            <div key={id} style={{marginBottom:"10px", textAlign: item.userVishalid === user.id ? 'right' : 'left' }}>
